  ...
  describe("getGraphData", function() {
      ...
      it("should return cached data if there is otherwhise call api and add pending data as timedout", function() {
        ...
        runs(function() {
          ...
          FlurryFactory.getGraphData(['ActiveUsers', 'Sessions', 'PageViews'], '2013-10-01', '2013-11-12', {retries : 0, timeout : 15000})
      ...
      it("should return api data if the dates of the cached data don't cover the requested dates", function() {
        ...
        runs(function() {
          ...
          FlurryFactory.getGraphData(['ActiveUsers'], '2013-10-01', '2013-11-13', {retries : 0, timeout : 15000})
          .then(function(newData){
            data = newData;           
          });
      ...
      it("should return data from the api if no cached data exists", function() {
        ...
        runs(function() {
          ...
          FlurryFactory.getGraphData(['Sessions'], '2013-10-01', '2013-11-12', {retries : 0, timeout : 15000})
          .then(function(newData){
            data = newData;           
          });
      ...
      it("should return timedout data if api takes too long to return data", function() {
        ...
        runs(function() {
          ...
          FlurryFactory.getGraphData(['Sessions'], '2013-10-01', '2013-11-12', {retries : 0, timeout : 100})
          .then(function(newData){
            data = newData;           
          });
      ...
      it("should return data from the api if no cached data exists on first run. Return cached data on second run if dates are covered", function() {
        ...
        runs(function() {
          ...
          runs(function() {
            ...
            FlurryFactory.getGraphData(['Sessions'], '2013-10-01', '2013-11-11', {retries : 0, timeout : 15000})
            .then(function(newData){
              data = newData;           
            });
          ...
          runs(function() {
            ...
            runs(function() {
              ...
              FlurryFactory.getGraphData(['Sessions'], '2013-10-02', '2013-11-12', {retries : 0, timeout : 15000})
              .then(function(newData){
                data = newData;           
              });
